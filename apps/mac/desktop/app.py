...
def discover_project_root() -> Path:
    ...
    required_markers = ("rag", "scripts", "requirements")
    optional_markers = ("workspace/vector_db", "workspace/kb_sources", ".env")
...
def bootstrap_pipeline(project_root: Path) -> InitSuccess:
    ...
    kb_rebuilt = ensure_kb_current(
        source_dir=os.getenv("KB_SOURCE_DIR", "workspace/kb_sources"),
        embedding_model=embedding_model,
        faiss_index_path=faiss_index_path,
        chunks_path=chunks_path,
        manifest_path=os.getenv("KB_MANIFEST_PATH", "workspace/vector_db/source_manifest.json"),
